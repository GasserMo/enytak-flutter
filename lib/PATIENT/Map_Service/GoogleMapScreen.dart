...
class _GoogleMapScreenState extends State<GoogleMapScreen> {
  ...
  Future<void> _submitLocation() async {
    final url = Uri.parse('http://164.92.111.149/api/locations/add/');
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        final serviceIds = selectedService['service_ids'] as List;
        ...
        } else if (subcategoryIds.isNotEmpty && serviceIds.isNotEmpty) {
          Navigator.push(
            context,
            MaterialPageRoute(
                ...
                subCategories: [
                  {
                    'name': 'Subcategory 1',
                    'services': [
                      {'name': 'Service A', 'icon': Icons.local_hospital},
                      {'name': 'Service B', 'icon': Icons.medical_services},
                    ],
                  },
                  {
                    'name': 'Subcategory 2',
                    'services': [
                      {'name': 'Service C', 'icon': Icons.healing},
                      {'name': 'Service D', 'icon': Icons.health_and_safety},
                    ],
                  },
                ],
              ),
        ...
        } else if (subcategoryIds.isEmpty && serviceIds.isNotEmpty) {
          Navigator.push(
            context,
            MaterialPageRoute(
