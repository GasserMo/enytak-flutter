...
class _HospitalUserProfileState extends State<HospitalUserProfile> {
  ...
  Future<void> fetchAvailabilities() async {
    ...
    final String apiUrl = 'http://164.92.111.149/api/availabilities/';
  ...
  Future<void> fetchHospital() async {
    ...
    final String apiUrl =
        'http://164.92.111.149/api/hospitals/$hospitalId/'; // Use dynamic hospitalId here
  ...
  Future<void> fetchServices(List<String> serviceNames) async {
    final String servicesUrl =
        'http://164.92.111.149/api/hospitals/$hospitalId/services/';
  ...
  Future<void> fetchNurseDetails(int nurseId, List<String> nurseNames) async {
    final String nurseApiUrl = 'http://164.92.111.149/api/nurses/$nurseId/';
  ...
  Future<void> fetchDoctorDetails(
    ...
    final String doctorApiUrl = 'http://164.92.111.149/api/doctors/$doctorId/';
  ...
  Future<void> fetchServiceDetails(
    ...
    final String serviceApiUrl =
        'http://164.92.111.149/api/services/$serviceId/';
