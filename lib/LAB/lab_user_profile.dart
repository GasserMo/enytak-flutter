...
import 'package:flutter_sanar_proj/LAB/Edit_Provider.dart';
...
import 'package:flutter_sanar_proj/LAB/add_service_lab.dart';
...
class _LabUserProfileState extends State<LabUserProfile> {
  ...
  Future<void> fetchLab() async {
    ...
    final String apiUrl =
        'http://164.92.111.149/api/labs/$labId/'; // Use dynamic hospitalId here
  ...
  Future<void> fetchServices() async {
    final String servicesUrl =
        'http://164.92.111.149/api/labs/$labId/services/';
